import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, unref, mergeProps, withCtx, renderSlot, useSlots, ref, inject, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, resolveDynamicComponent, defineComponent, shallowRef, h, resolveComponent, toValue, watch, hasInjectionContext, getCurrentInstance, provide, useModel, createTextVNode, mergeModels, onServerPrefetch, nextTick, toRef, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, Suspense, Fragment, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, useTemplateRef, withModifiers, toHandlers, createSlots, getCurrentScope, isRef, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, k as klona, l as defu, m as parseQuery, n as defuFn, o as isEqual, q as hasProtocol, j as joinURL, r as parseURL, t as encodePath, v as decodePath, w as withQuery, x as isScriptProtocol, y as getContext, z as withTrailingSlash, A as withoutTrailingSlash, B as sanitizeStatusCode, e as createError$1, $ as $fetch$1, C as baseURL, D as createHooks, E as executeAsync } from '../nitro/nitro.mjs';
...
import { Primitive, useForwardProps, createContext, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, VisuallyHidden, DialogRoot, DialogContent, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, DropdownMenuRoot, DropdownMenuTrigger, DropdownMenuArrow, ProgressRoot, ProgressIndicator, Separator } from 'reka-ui';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index--sFg0lkW.mjs')
  }
];
...
const _sfc_main$l = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$c), ...appConfig2.ui?.progress || {} })({
...
const _sfc_main$k = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$b), ...appConfig2.ui?.toast || {} })({
      color: props.color,
      orientation: props.orientation,
...
const _sfc_main$j = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$a), ...appConfig2.ui?.toaster || {} })({
      position: props.position,
...
const _sfc_main$g = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$9), ...appConfig2.ui?.container || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
const _sfc_main$f = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.slideover || {} })({
...
const _sfc_main$e = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$7), ...appConfig2.ui?.modal || {} })({
      transition: props.transition,
...
const _sfc_main$d = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig2.ui?.drawer || {} })({
...
const _sfc_main$c = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.header || {} })());
    const Menu = computed(() => ({
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$m, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$1]]), { __name: "AppLogo" });
const kbdKeysMap = {
  meta: "",
  ctrl: "",
  alt: "",
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.loading ? (openBlock(), createBlock(_sfc_main$r, {
                    key: 0,
                    name: __props.loadingIcon || unref(appConfig2).ui.icons.loading,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, loading: true })
                  }, null, 8, ["name", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$r, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "itemLeadingIcon",
                    class: __props.ui.itemLeadingIcon({ class: [__props.uiOverride?.itemLeadingIcon, item.ui?.itemLeadingIcon], color: item?.color, active })
                  }, null, 8, ["name", "class"])) : item.avatar ? (openBlock(), createBlock(_sfc_main$p, mergeProps({
                    key: 2,
                    size: item.ui?.itemLeadingAvatarSize || __props.uiOverride?.itemLeadingAvatarSize || __props.ui.itemLeadingAvatarSize()
                  }, item.avatar, {
                    "data-slot": "itemLeadingAvatar",
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : "item-description"]) ? (openBlock(), createBlock("span", {
                  ...
                  createVNode("span", {
                    ...
                    item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$r, {
                      key: 0,
                      name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                      "data-slot": "itemLabelExternalIcon",
                      class: __props.ui.itemLabelExternalIcon({ class: [__props.uiOverride?.itemLabelExternalIcon, item.ui?.itemLabelExternalIcon], color: item?.color, active })
                ...
                createVNode("span", {
                  ...
                  renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                    ...
                    item.children?.length ? (openBlock(), createBlock(_sfc_main$r, {
                      key: 0,
                      name: childrenIcon.value,
                      "data-slot": "itemTrailingIcon",
                      class: __props.ui.itemTrailingIcon({ class: [__props.uiOverride?.itemTrailingIcon, item.ui?.itemTrailingIcon], color: item?.color, active })
                        ...
                        if (_push4) {
                          ...
                          ssrRenderList(group, (item, index2) => {
                            ...
                            if (item.type === "label") {
                              ...
                              _push4(ssrRenderComponent(_sfc_main$n, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                default: withCtx(({ active, ...slotProps }, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(ssrRenderComponent(unref(DropdownMenu).Item, {
                                      ...
                                      default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          _push6(ssrRenderComponent(_sfc_main$o, mergeProps({ ref_for: true }, slotProps, {
                                            "data-slot": "item",
                                          ...
                                          return [
                                            createVNode(_sfc_main$o, mergeProps({ ref_for: true }, slotProps, {
                                              "data-slot": "item",
                                              class: __props.ui.item({ class: [__props.uiOverride?.item, item.ui?.item, item.class], color: item?.color, active })
                                            }), {
                                              default: withCtx(() => [
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(group, (item, index2) => {
                              return openBlock(), createBlock(Fragment, {
                                ...
                                item.type === "label" ? (openBlock(), createBlock(unref(DropdownMenu).Label, {
                                  ...
                                  _: 2
                                }, 1032, ["model-value", "disabled", "text-value", "class", "onUpdate:modelValue", "onSelect"])) : (openBlock(), createBlock(_sfc_main$n, mergeProps({
                                  key: 4,
                                  ref_for: true
              ...
              __props.label || __props.icon || __props.avatar || !!slots.default ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode("div", {
                  ...
                  renderSlot(_ctx.$slots, "default", { ui: ui.value }, () => [
                    ...
                    }, toDisplayString(__props.label), 3)) : __props.icon ? (openBlock(), createBlock(_sfc_main$r, {
                      key: 1,
                      name: __props.icon,
                      "data-slot": "icon",
                      class: ui.value.icon({ class: unref(uiProp)?.icon })
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Hyrbzqub.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-_BYQmSYw.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useAppConfig as b, useComponentUI as c, _sfc_main$g as d, entry_default as default, _sfc_main$m as e, _sfc_main$r as f, getSlotChildrenText as g, _sfc_main$n as h, tv as t, useHead as u };
